...
class ChipValueWindow(Gtk.Window):
    def __init__(self, parent, is_admin=True):
        super().__init__(title="Chipwerte Verwaltung")
        self.set_default_size(800, 480)
        self.set_transient_for(parent)
        self.set_modal(True)
        self.parent = parent
        self.is_admin = is_admin  # Whether this window is opened in admin mode
    ...
    def create_ui(self):
        ...
        title_label.set_markup("<span size='x-large' weight='bold' foreground='#CDAD00'>Chipwerte Übersicht</span>")
        ...
        for i, (chip_file, chip_value) in enumerate(sorted_chips):
            ...
            # Display and make CHF value clickable if in admin mode
            ...
            if self.is_admin:
                # In admin mode: Button with CHF value
